...
// see https://github.com/OAI/OpenAPI-Specification/blob/3.1.0/versions/3.1.md
 ...
 * Specification:
 * https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.1.0.md#parameter-locations
 */
 ...
 * Specification:
 * https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.1.0.md#style-values
 */
...
export interface SchemaObject extends ISpecificationExtension {
    ...
    multipleOf?: number;
    maximum?: number;
    /** @desc exclusiveMaximum: number in OpenAPI 3.1. It was a boolean in OpenAPI 3.0. Breaking change */
    exclusiveMaximum?: number;
    minimum?: number;
    /** @desc exclusiveMinimum: number in OpenAPI 3.1. It was a boolean in OpenAPI 3.0. Breaking change */
